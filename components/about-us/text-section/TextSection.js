    ...
    <section className="w-full py-[100px] bg-[#fff] relative overflow-hidden">
      <div className='myContainer'>
        ...
        <div className='flex flex-wrap justify-between gap-y-[140px] gap-x-[3%]'>
          ...
          <div className='w-[48%] '>
            <h1 className='fpr text-[#0F2E3C] text-[100px] leading-[100px] max-w-[633px]'>Our values and principals</h1>
          </div>
          <p className='w-[48%] fgr text-[#555555] text-[24px] leading-[42px] flex items-center'>From the services we provide to our corporate culture, our goal is for everything we do to live up to our core values and principles.</p>
